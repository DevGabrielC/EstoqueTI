...
import co.devgabrielc.br.model.repositories.Estoque;
...
import static co.devgabrielc.br.model.database.DatabaseConnection.atualizarBancoDeDados;
...
public class MainController {
    ...
    private void handleAddScreen(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(MainController.class.getResource("/co/devgabrielc/br/model/views/AddScreen.fxml"));
