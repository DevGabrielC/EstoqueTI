...
import static co.devgabrielc.br.model.services.Functions.showAlertError;
...
public class AddScreenController {
    ...
    void handleAtivoImobilizadoScreen(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/co/devgabrielc/br/model/views/AtivoImobilizado.fxml"));
    ...
    void handleUsoConsumoScreen(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/co/devgabrielc/br/model/views/UsoConsumo.fxml"));
            Parent initialize = loader.load();
    ...
    void handleCancelar(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/co/devgabrielc/br/model/views/MainScreen.fxml"));
            Parent initialize = loader.load();
