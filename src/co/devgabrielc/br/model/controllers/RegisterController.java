...
import static co.devgabrielc.br.model.services.Functions.showAlertSuccess;
...
public class RegisterController {
    ...
    void handleCancelar() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/co/devgabrielc/br/model/views/LoginScreen.fxml"));
